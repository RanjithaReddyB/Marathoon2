...
{
    /// <summary>
    /// Transaction Upload history entity mapping for Entity Framework.
    /// </summary>
    public class TransactionUploadHistoryMap : EntityTypeConfiguration<TransactionUploadHistory>
    {
        public TransactionUploadHistoryMap()
        {
            // Properties
            ...
            this.ToTable("TransactionUploadHistory");
