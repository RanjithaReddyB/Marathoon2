...
{
    /// <summary>
    /// Bulk transfer history entity mapping for Entity Framework.
    /// </summary>
    public class BulkTransferHistoryMap : EntityTypeConfiguration<BulkTransferHistory>
    {
        public BulkTransferHistoryMap()
        {
            // Properties
            ...
            this.ToTable("BulkTransferHistory");
